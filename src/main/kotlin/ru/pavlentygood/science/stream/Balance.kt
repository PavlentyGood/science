...
/*
Функция для занесения средств на баланс.
Принимает начальный баланс и итератор от бесконечной последовательности сумм занесения на баланс,
а возвращает потенциально бесконечную последовательность значений баланса.
 */
